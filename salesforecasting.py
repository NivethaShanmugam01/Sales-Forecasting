...
<div style='text-align:center'>
    <h1 style='color:#009999;'>Sales Forecasting</h1>
</div>
...
if submit_button and flag==0:
    ...
    import pickle 
    with open(r"C:\Users\YOGA\Downloads\sfmodel2.pkl", 'rb') as file:
        loaded_model = pickle.load(file)
    with open(r"C:\Users\YOGA\Downloads\sfscaler2.pkl", 'rb') as f:
